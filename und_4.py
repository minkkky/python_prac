...
mFONT = pg.font.Font("font.ttf", 35)
wFONT = pg.font.Font("font.ttf", 70)
...
text_up = mFONT.render("UP! 정답보다 크네요.", True, RED)
text_down = mFONT.render("DOWN! 정답보다 작네요.", True, RED)
...
def result_msg(): # 결과 메시지를 띄워준다
    global screen, result, FONT, wFONT, mFONT, text_up, text_down, text_redo, text_win
